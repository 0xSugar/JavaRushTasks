...
public class Solution {
    ...
    public static void main(String[] args) {
        // TaskDataProvider используя Task и MockDB, цель которого - обновить поле tasks.
        Solution solution = new Solution();
        solution.taskDataProvider.refreshAllData(MockView.getFakeTaskCriteria());
        solution.nameDataProvider.refreshAllData(MockView.getFakeNameCriteria());
