...
//        return (a && b && c && !d) || (!a && c) || (!b && c) || (c && d);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(calculate(true, true, false, true));     //false     | c
        System.out.println(calculate(true, true, true, false));     //true
        System.out.println(calculate(false, true, false, true));    //false     | c
        System.out.println(calculate(true, false, true, false));    //true
        System.out.println(calculate(true, false, false, true));    //false     | c
        System.out.println(calculate(false, true, true, false));    //true
        System.out.println(calculate(false, false, false, false));  //false     | c
