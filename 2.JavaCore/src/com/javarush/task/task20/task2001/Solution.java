...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("/Users/skul/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2001/file.txt", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            writer.println((name != null) ? this.name : "No name");
            if (assets != null) {
