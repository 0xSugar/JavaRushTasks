...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File yourFile = new File("/Users/skul/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2004/file.txt");
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            pw.println(staticString != null ? staticString : "null");
            pw.println(i);
            pw.println(j);
            pw.flush();
        }
